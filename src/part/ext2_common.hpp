 ...
 */
#define EXT2_HAS_COMPAT_FEATURE(sb, mask) (le32(EXT2_SB(sb)->s_feature_compat) & (mask))
#define EXT2_HAS_RO_COMPAT_FEATURE(sb, mask) (le32(EXT2_SB(sb)->s_feature_ro_compat) & (mask))
#define EXT2_HAS_INCOMPAT_FEATURE(sb, mask) (le32(EXT2_SB(sb)->s_feature_incompat) & (mask))
